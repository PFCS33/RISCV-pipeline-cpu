...
#
    ...
    bne     t2, t3, srl_error
    addi    t1, zero, -216     # t1 = 0xffff ff28
    srl     t2, t0, t1          # t2 = t0 >>l t1[4:0] // 0x300 >>l 0x8 => 0x3
    addi    t3, zero, 0x3       # t3 = 0x3
    bne     t2, t3, srl_error
    addi    t0, zero, -2048     # t0 = 0xffff f800
    addi    t1, zero, -200     # t1 = 0xffff ff38
...
sra_ok:
    ...
    addi    t0, zero, -256     # t0 = 0xffff ff00
...
slli_ok:
    ...
    addi    t0, zero, -1     # t0 = 0xffff ffff => -1
    ...
    bne     t2, t3, slt_error
    addi    t0, zero, -1     # t0 = 0xffff ffff => -1
    addi    t1, zero, -2     # t1 = 0xffff fffe => -2
...
slt_ok:
    ...
    bne     t2, t3, slti_error
    slti    t2, t0, -2       # t2 = t0 < 0xffff fffe => -2 // -1 < -2 => 0
    addi    t3, zero, 0x0       # t3 = 0x0
    bne     t2, t3, slti_error
    addi    t0, zero, 0x7ff     # t0 = 0x7ff
...
slti_ok:
    ...
    bne     t2, t3, sltu_error
    addi    t1, zero, -16     # t1 = 0xffff fff0
...
sltu_ok:
    ...
    bne     t2, t3, sltiu_error
    sltiu   t2, t0, -16       # t2 = t0 < 0xffff fff0 // 0xffff ffff < 0xffff fff0 => 0
    bne     t2, t3, sltiu_error
    addi    t0, zero, 0x7ff     # t0 = 0x7ff
...
and_ok:
    ...
    andi    t2, t0, -1       # t2 = t0 & 0xffff ffff // 0x0 & 0xffff ffff => 0x0
    bne     t2, t3, andi_error
    addi    t0, zero, 0x115     # t0 = 0x115
    andi    t2, t0, -1       # t2 = t0 & 0xffff ffff // 0x115 & 0xffff ffff => 0x115
...
xori_ok:
    ...
    addi    t1, zero, -1     # t1 = 0xffff ffff => -1
    blt     t1, t1, blt_error   # if -1 < -1
    blt     t0, t1, blt_error   # if 0x0 < -1
    addi    t0, zero, -2     # t0 = 0xffff fffe => -2
